...
$sonuc= mysqli_query($baglan, "select * from hastaBilgi");
...
if($kayitSayisi==0)
    ...
    echo "</tr>";
      ...
      echo "<td>".$satir['sikayetID']."</td>";
			echo "</tr>";
		}
		echo "</table>";
    echo "<hr>";
    echo "<table border=1 cellspace=2 >";
    echo "<td>"."SIKAYETLER <br>"."</td>";
    echo "<td>"."1= Baş ağrısı <br>"."</td>";
    echo "<td>"."2= Yüksek Ateş<br>"."</td>";
    echo "<td>"."3= Bel Ağrısı<br>"."</td>";
    echo "<td>"."4= Grip<br>"."</td>";
    echo "<td>"."5= Eklem Ağrısı<br>"."</td>";
    echo "<td>"."6= Korona<br>"."</td>";
    echo "</table>";
    echo "</center>";
}
