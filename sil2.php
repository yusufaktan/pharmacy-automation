...
$sonuc= mysqli_query($baglan, "select * from ilacBilgi");
  ...
  echo "<center>";
    ...
    echo "<center>";
		...
		while($satir=mysqli_fetch_array($sonuc)){
			...
			echo "<td>".$satir['ilacID']."</td>";
			echo "<td>".$satir['ILACADI']."</td>";
			echo "<td>".$satir['FIYAT']."</td>";
			echo "<td>".$satir['STOK']."</td>";
			echo "<td>
	<a href=ilacsil.php?ID=".$satir['ilacID']." onclick=\"return uyari();\">Sil</a>
